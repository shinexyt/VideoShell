using VideoShell.Behaviors.Base;
using System;
...
namespace VideoShell.Behaviors
{
    public class EventToCommandBehavior : BindableBehavior<ContentPage>
    {
        ...
        protected override void OnAttachedTo(ContentPage visualElement)
        {
